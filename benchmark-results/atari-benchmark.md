...
- **CrossQ** *(experimental)*: [crossq_atari.yaml](https://github.com/kengz/SLM-Lab/blob/master/slm_lab/spec/benchmark/crossq/crossq_atari.yaml) - Categorical CrossQ, AdamW (lr=1e-3), training_iter=3, FC1024 critics, max_frame=2e6 — tested on 6 games only
