...
See [slm_lab/spec/benchmark/dqn/](https://github.com/kengz/SLM-Lab/tree/master/slm_lab/spec/benchmark/dqn) for example specs of DQN variations (DQN, DoubleDQN, DDQN+PER). Parameters are explained below.
